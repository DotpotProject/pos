...
QUnit.test( "phoneUK", function( assert ) {
	...
	assert.ok( method( "01633 ffaf7a" ), "Valid UK Phone Number" );
	...
	assert.ok( method( "0500 ffaf7a" ), "Valid UK Phone Number" );
	assert.ok( method( "055 3555 5555" ), "Valid UK Phone Number" );
	assert.ok( method( "07122 ffaf7a" ), "Valid UK Phone Number" );
	assert.ok( method( "07222 ffaf7a" ), "Valid UK Phone Number" );
	assert.ok( method( "07322 ffaf7a" ), "Valid UK Phone Number" );
	...
	assert.ok( !method( "7222 ffaf7a" ), "Invalid UK Phone Number" );
	assert.ok( !method( "+44 07222 ffaf7a" ), "Invalid UK Phone Number" );
} );
