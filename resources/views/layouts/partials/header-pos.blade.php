    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <a href="{{$go_back_url}}" title="{{ __('lang_v1.go_back') }}"
                class="btn btn-info   rounded-3 m-6 btn-xs m-5 pull-right">
            ...
            <button data-placement="bottom" data-toggle="tooltip" type="button" id="close_register"
                ...
                class="btn btn-danger   rounded-3 m-6 btn-xs m-5 btn-modal pull-right"
            ...
            <button data-placement="bottom" data-toggle="tooltip" type="button" id="register_details"
                ...
                class="btn btn-success   rounded-3 m-6 btn-xs m-5 btn-modal pull-right"
            ...
            <button title="@lang('lang_v1.calculator')" id="btnCalculator" type="button"
                class="btn btn-success   rounded-3 pull-right m-5 btn-xs mt-10 popover-default" data-toggle="popover"
            ...
            <button type="button" class="btn btn-danger   rounded-3 m-6 btn-xs m-5 pull-right" id="return_sale"
            ...
            <button type="button" title="{{ __('lang_v1.full_screen') }}"
                class="btn btn-primary   rounded-3 m-6 hidden-xs btn-xs m-5 pull-right" id="full_screen">
            ...
            <button type="button" id="view_suspended_sales" title="{{ __('lang_v1.view_suspended_sales') }}"
                class="btn bg-yellow   rounded-3 m-6 btn-xs m-5 btn-modal pull-right" data-container=".view_modal"
            ...
            <button type="button" title="{{ __('lang_v1.view_products') }}" data-placement="bottom"
                class="btn btn-success   rounded-3 m-6 btn-xs m-5 btn-modal pull-right" data-toggle="modal"
            ...
            <a href="{{action('SellPosController@create')}}" title="@lang('sale.pos_sale')"
                class="btn btn-success   rounded-3 m-6 btn-xs m-5 pull-right">
            ...
            <button type="button" data-placement="bottom" data-toggle="tooltip" title="{{ __('expense.add_expense') }}"
                data-placement="bottom" class="btn bg-purple   rounded-3 m-6 btn-xs m-5 btn-modal pull-right"
                id="add_expense">
