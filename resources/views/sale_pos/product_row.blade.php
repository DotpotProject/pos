...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td>
		...
		<div class="input-group input-number">
			<span class="input-group-btn"><button type="button" class="btn btn-default   rounded-3 quantity-down"><i class="fa fa-minus text-danger"></i></button></span>
		<input type="text" data-min="1" 
			...
			@endif 
		>
		<span class="input-group-btn"><button type="button" class="btn btn-default   rounded-3 quantity-up"><i class="fa fa-plus text-success"></i></button></span>
		</div>
