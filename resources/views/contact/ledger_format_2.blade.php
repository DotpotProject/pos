...
<div class="col-md-12 col-sm-12 @if(!empty($for_pdf)) width-100 @endif">
	...
	<table class="table" style="margin-top: 0;">
		<tr>
			...
			<th style="color: #ff9957 !important;font-size: 12px;">{{strtoupper(__('lang_v1.1_30_days_past_due'))}}</th>
			...
			<th style="color: #ff9957 !important;font-size: 12px;">{{strtoupper(__('lang_v1.over_90_days_past_due'))}}</th>
		...
		<tr>
			...
			<td style="color: #ff9957 !important; text-align: center;">
